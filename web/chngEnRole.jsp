            ...
            <div class="row">
                <div class="col-md-2 col-md-offset-5">
                    ...
                    <div class="panel panel-default">
                        <form method="post" action="changeEnseignantRole">  
                            <div class="panel-heading">
                                <h4>Changer le role</h4>
                            </div>
                            <div class="panel-body"> 
                                <input type="hidden" name="idEn" value="<%=session.getAttribute("idEnseignant")%>">
                                <input  type="radio" name="type"  value="Admin" checked required><label style="margin-left: 5px">Admin</label><br><br>
